@ExcelTesti
Feature: US1013 kullanici excel olarak verilen listedeki urunleri aratir

  Scenario Outline: TC001 excelden sececegimiz satirdaki urunlerin min urun sayisi test edilir
